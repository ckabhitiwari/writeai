...
const FooterOne = () => {
  return (
    <>
      <footer className="uxora-footer-section">
          ...
          <div className="row">
            <div className="col-xxl-4 col-xl-12 col-md-12">
              <div className="uxora-footer-textarea">
                ...
                <div className="uxora-conatct-info">
                  <ul>
                    <li>
            ...
            <div className="col-xxl-3 col-xl-4 col-md-3">
              <div className="uxora-footer-menu menu1 menu1 pl-60">
                <h3>Quick Links</h3>
                <ul>
                  <li>
                    <Link href="/">Home</Link>
            ...
            <div className="col-xxl-3 col-xl-4 col-md-5">
              <div className="uxora-footer-menu menu1 menu2">
                <h3>Product</h3>
                <ul>
                  <li>
